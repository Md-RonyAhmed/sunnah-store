...
const Ebook = () => {
  ...
  return (
      <div
        className="fixed left-5 top-3/4 -rotate-90 origin-left bg-gray-600 text-white px-3 py-2 rounded-b-md shadow-lg cursor-pointer text-sm md:text-base lg:text-lg"
